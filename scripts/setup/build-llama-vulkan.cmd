...
rem Build llama.cpp with Vulkan backend using MSVC
rem Persists build to projects\llama.cpp\build-vulkan\
...
:vulkan_found
if "%VULKAN_SDK_FOUND%"=="0" (
    echo ERROR: Vulkan SDK not found in C:\VulkanSDK\
    echo Install from https://vulkan.lunarg.com/sdk/home#windows
    exit /b 1
)
...
cmake -B "%BUILD_DIR%" ^
    ...
    -DVulkan_LIBRARY="%VULKAN_SDK_DIR%\Lib\vulkan-1.lib"
if errorlevel 1 (
