...
- **Why it was wrong.** The hook was catching a real problem (version pin divergence). The rust-guard correctly blocked `--no-verify`. Pydantic was eventually aligned to `2.13.1` — which was the right fix all along.
