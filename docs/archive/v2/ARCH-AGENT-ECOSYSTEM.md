...
> How containerised AI agents, the gateway, chat UI, task engine, and A2A protocol connect across WORKSPACE-VM, AMI-TRADING, and AMI-SRP.
...
|---------------------|---------------|---------------------|------|
| Agent Container Isolation | WORKSPACE-VM | WORKSPACE-VM | `docs/REQ-AGENT-CONTAINERS.md` |
...
| This document | WORKSPACE-VM | N/A | `docs/ARCH-AGENT-ECOSYSTEM.md` |
